 ...
 * @since AM 5.5.0
 */
public class VoisentryAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(VoisentryAuthNodePlugin.currentVersion,
	...
	public void onInstall() throws PluginException {
            pluginTools.installService(VoisentryService.class);
            super.onInstall();
	}
	...
	public void onStartup(StartupType startupType) throws PluginException {
            pluginTools.startService(VoisentryService.class);
	...
	public String getPluginVersion() {
		return VoisentryAuthNodePlugin.currentVersion;
	}
}
